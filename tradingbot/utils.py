...
def calculate_position_size(balance, position_price, atr, risk_percent=0.01):
    # calculate the dollar amount you're willing to risk
    risk_amount = balance * risk_percent

    # calculate stop loss distance as a multiple of ATR (e.g., 1 ATR)
    stop_loss_distance = atr  # You can scale this based on your preference, e.g., 1 * ATR or 1.5 * ATR
